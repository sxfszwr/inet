...
#include "inet/protocol/checksum/FcsInserter.h"
#include "inet/protocol/contract/IProtocol.h"

namespace inet {

Define_Module(FcsInserter);

void FcsInserter::initialize(int stage)
{
...
void FcsInserter::processPacket(Packet *packet)
{
