...
class INET_API Transmitter : public PassivePacketSinkBase
{
  ...
  public:
    ...
    virtual void pushPacketProgress(Packet *packet, b position, b extraProcessableLength = b(0), cGate *gate = nullptr) override { throw cRuntimeError("Invalid operation"); }
    virtual b getPushedPacketProcessedLength(Packet *packet, cGate *gate = nullptr) override { throw cRuntimeError("Invalid operation"); }
};
