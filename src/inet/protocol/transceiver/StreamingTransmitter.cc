...
simtime_t StreamingTransmitter::calculateDuration(Packet *packet, bps datarate) const
{
...
void StreamingTransmitter::pushPacketProgress(Packet *packet, b position, b extraProcessableLength, cGate *gate)
{
}

b StreamingTransmitter::getPushedPacketProcessedLength(Packet *packet, cGate *gate)
{
    return b(0);
}
