...
#ifndef __INET_STARTSTOPTRANSMITTER_H
#define __INET_STARTSTOPTRANSMITTER_H
...
class INET_API StartStopTransmitter : public PassivePacketSinkBase
{
  ...
  public:
    virtual ~StartStopTransmitter() { cancelAndDelete(txEndTimer); }
...
#endif // ifndef __INET_STARTSTOPTRANSMITTER_H
