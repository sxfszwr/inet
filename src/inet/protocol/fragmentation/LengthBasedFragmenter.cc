...
#include "inet/protocol/fragmentation/LengthBasedFragmenter.h"
#include "inet/protocol/fragmentation/FragmentNumberHeader_m.h"
#include "inet/protocol/contract/IProtocol.h"

namespace inet {

Define_Module(LengthBasedFragmenter);

void LengthBasedFragmenter::initialize(int stage)
{
...
std::vector<b> LengthBasedFragmenter::computeFragmentLengths(Packet *packet) const
{
