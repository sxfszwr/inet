...
class INET_API SendToMacAddress : public PacketFlowBase
{
  ...
  public:
    virtual bool canPushSomePacket(cGate *inGate = nullptr) const override { return consumer->canPushSomePacket(outputGate->getPathEndGate()); }
    virtual bool canPushPacket(Packet *packet, cGate *inGate = nullptr) const override { return consumer->canPushPacket(packet, outputGate->getPathEndGate()); }
