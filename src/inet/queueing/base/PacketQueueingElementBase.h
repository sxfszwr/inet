...
class INET_API PacketQueueingElementBase : public cSimpleModule, public IPacketQueueingElement
{
  protected:
    ...
    virtual void checkPacketPushingOrPullingSupport(cGate *gate) const;
    ...
    virtual void pushOrSendPacketProgress(Packet *packet, b position, b extraProcessableLength, cGate *gate, IPassivePacketSink *consumer);
